...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiapy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11326&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiapy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiapy` can be installed with:

```
conda install aiapy
```

It is possible to list all of the versions of `aiapy` available on your platform with:
